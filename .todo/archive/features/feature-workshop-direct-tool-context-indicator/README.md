...
**Status**: Archived — delivered by the Sprint 14 instrument-audience clarity
pass; the final design uses a persistent private-thread scope card and
per-turn audience labels rather than the proposed dotted divider
**Priority**: Medium
