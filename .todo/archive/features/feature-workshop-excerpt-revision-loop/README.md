...
**Status**: Archived — delivered by [Sprint 06C](../../epics/epic-workshop-editor-tab-2026-07-03/sprints/06c-excerpt-revision-loop.md) under the [room-memory ADR](../../../../docs/adr/2026-07-11-workshop-excerpt-revision-and-room-memory.md); effective with PR #95
