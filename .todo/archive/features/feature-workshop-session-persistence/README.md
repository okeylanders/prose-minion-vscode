...
**Status**: Archived — delivered in
[PR #85](https://github.com/okeylanders/prose-minion-vscode/pull/85), hardened
for Marketplace input, and released to `main` through PR #95. See
...
- **Multiple manuscripts / branch-board interplay.** If
  [feature-workshop-branch-board](../../../features/feature-workshop-branch-board/README.md)
