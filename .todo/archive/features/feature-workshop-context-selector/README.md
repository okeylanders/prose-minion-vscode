...
**Source**: User request
**Status**: Archived — delivered in Sprint 12 and persisted by Sprint 10;
effective with PR #95. The implementation includes multiple typed
attachments, the shared Context Selector/browser shell, project-resource
search, composer attachment intake, and bounded provenance.
**Priority**: High
