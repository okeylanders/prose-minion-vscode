...
**Status**: Archived — implemented and integrated into the Workshop beta;
effective with PR #95
**Priority**: High
...
**Related feature**: [Workshop Relational Depth](../../../features/feature-workshop-relational-depth/README.md)
