...
**Absorbs**: [archived prompt-budget centralization debt](../../../tech-debt/2026-07-11-prompt-truncation-budget-centralization.md) as Task 0; the **paste-only slice** of [feature-workshop-context-selector](../../../features/feature-workshop-context-selector/README.md) (editable context brief — the selector modal stays in that entry)
