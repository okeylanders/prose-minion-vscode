...
**Created**: 2026-07-06
**Status**: Complete — release candidate in [PR #95](https://github.com/okeylanders/prose-minion-vscode/pull/95); archive becomes effective when that PR merges
**Progress**: All planned sprints through Sprint 14 are integrated. The beta
release candidate includes the final illustrated notice work, opt-in web
research, restored-panel activation, and Marketplace session-file hardening.
The Workshop was developed and reviewed incrementally through PRs #66–#94;
PR #95 is the single epic-to-main integration boundary.
...
**Related behavior features**: [Amplified Persona Expression](../../../features/feature-workshop-amplified-expression/README.md); [Relational Depth](../../../features/feature-workshop-relational-depth/README.md); [Writer Profile](../../features/feature-workshop-writer-profile/README.md)
**Integration branch**: `epic/workshop-editor-tab` → `main` via PR #95
...
| 13A | `sprint/workshop-editor-tab-13a-open-chat` | [Open Chat](sprints/13a-open-chat.md) | Writers can start an honest retained conversation before they have an excerpt, then visibly adopt one later. |
| 13B | `sprint/workshop-editor-tab-13b-run-local-analysis` | [Run-local analysis scope](sprints/13b-run-local-analysis.md) | One analysis run can inspect a bounded local subject with explicit inherited or replacement context. |
| 13C | `sprint/workshop-editor-tab-13c-guest-agency` | [Guest agency](sprints/13c-guest-agency.md) | Writers deliberately read in a guest; guests receive bounded, attributable capabilities rather than ambient power. |
| 13D | `sprint/workshop-editor-tab-13d-room-catchup-release-polish` | [Room catch-up & release polish](sprints/13d-room-catchup-release-polish.md) | Guests see a truthful bounded room ledger, and the full Workshop experience has release evidence. |
| 13D_2 | `sprint/workshop-editor-tab-13d_2-open-room-participants` | [Open room participants](sprints/13d_2-open-room-participants.md) | Open rooms admit persona guests without an excerpt, with truthful guest context and catch-up copy. |
| 14 | `sprint/workshop-editor-tab-14-design-catchup-release-candidate` | [Design catch-up & release candidate](sprints/14-design-catchup-release-candidate.md) | The Workshop matches the 2026-07-26 design drop — carded rail, sheet browsers, startup beta notices, refreshed model catalog, widgets-browser preview — and is release-ready. |
...
immediate schema migration. The Sprint 13 delivery sequence is explicitly post-persistence,
