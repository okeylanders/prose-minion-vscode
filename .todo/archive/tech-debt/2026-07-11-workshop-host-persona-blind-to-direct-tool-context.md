...
**Status**: Resolved — bounded direct-tool handoff shipped in Sprint 06B and is covered by the final Workshop suite
...
**Related Sprint**: `.todo/archive/epics/epic-workshop-editor-tab-2026-07-03/sprints/06b-tool-side-pass.md`
...
- [x] After Sprint 06B merges, verify end-to-end: run a tool → direct-chat
      with it → "Back to [persona]" → next host message: the persona
      demonstrably references the direct-tool exchange.
- [x] Delivery cursor advances (repeating the host turn does not re-deliver
      the same exchanges).
- [x] Two-tool scenario: exchanges from both sidecars hand off independently.
- [x] Archive this entry once verified.
