...
session persistence ([PR #85](https://github.com/okeylanders/prose-minion-vscode/pull/85)). Relational Depth and Writer Profile are integrated. Sprints 13A–13D_2 (open chat, run-local analysis, guest agency, room catch-up, open-room participants) are complete through [PR #91](https://github.com/okeylanders/prose-minion-vscode/pull/91). Sprint 14 (design catch-up & release candidate, planned 2026-07-26) applies the latest design drop and is intended as the final sprint before the Workshop release. (Sprint 01 [PR #66](https://github.com/okeylanders/prose-minion-vscode/pull/66); Sprint 02 [PR #67](https://github.com/okeylanders/prose-minion-vscode/pull/67); Sprint 03 [PR #68](https://github.com/okeylanders/prose-minion-vscode/pull/68); Sprint 04 [PR #69](https://github.com/okeylanders/prose-minion-vscode/pull/69))
