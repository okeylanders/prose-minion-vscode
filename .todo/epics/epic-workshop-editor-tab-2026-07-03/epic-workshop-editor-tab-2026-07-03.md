...
| 6B | `sprint/workshop-editor-tab-06b-tool-side-pass` | [Retained tool sidecars and direct mode](sprints/06-tool-side-pass.md) | Every tool run preserves a verbatim report, feeds the host, and remains available for explicit direct follow-up. |
