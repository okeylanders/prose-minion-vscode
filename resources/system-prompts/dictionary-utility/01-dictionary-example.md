# Dictionary Utility — Reference Example

Use this exemplar as a stylistic benchmark. The sections, iconography, and depth demonstrate the expected richness and tone.
...
4. **Compressed/reduced (informal)**  
   - *Definition*: Subjected to severe reduction or constraint.  
   - *Example*: *Our timeline got crunched from six months to three weeks.*  
   - *Synonyms*: compressed, squeezed, condensed, contracted, shortened, reduced, tightened, constricted, limited, truncated, curtailed, diminished  
   - *Antonyms*: expanded, extended, stretched, prolonged, enlarged, relaxed  
   - *Nuance*: Conveys pressure, scarcity, and unwelcome constraint.
...
Reference this sample to maintain structural fidelity, sensory richness, and novelist-focused guidance.
