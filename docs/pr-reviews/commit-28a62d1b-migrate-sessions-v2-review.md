...
| 6 | 🟡 Standard | Dangling `passed.` fragment left in docs/CHANGELOG-DETAILED.md "Release validation" — ships in the public v2.2.0 changelog | Stan | — | **Addressed** — removed before release |
