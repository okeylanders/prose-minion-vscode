...
| 11 | 🟡 Standard | Guest transcript/catch-up/handoff packer duplicates the pre-existing direct-tool handoff bounded-packing algorithm (already diverges `push`/`unshift`) | Marcus | — | **Deferred** — tracked in [Workshop bounded turn packer](../../.todo/archive/tech-debt/2026-07-14-workshop-bounded-turn-packer.md) |
