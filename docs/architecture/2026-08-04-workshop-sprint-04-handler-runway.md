...
|---|---|---|---|---|
| 1 | Cut by **helper closure**, not by the historical route list | Sprint scope inherited the now-retired Conversation Widgets Sprint 02C "eight-route" seam | Two clusters: **excerpt + scope** (6 routes) and **context + resources** (13 routes). The historical 02C list split three shared helpers (**F1**); the corrected cut is recorded in the completed [Workshop Architecture Refactor Sprint 04](../../.todo/epics/epic-workshop-architecture-refactor-2026-08-03/sprints/04-application-handler-extraction.md) | STRONG — measured and accepted (D1=C) |
...
|---|---|---|---|
| "Extract the planned scope/context route cluster" | Sprint 04 scope | The source was the now-retired Conversation Widgets Sprint 02C plan, marked *Superseded 2026-08-03 — mandatory work moved to Phase 4*, whose own "Out of Scope" list excluded the routes that shared its helpers. The accepted replacement is the completed [Workshop Architecture Refactor Sprint 04](../../.todo/epics/epic-workshop-architecture-refactor-2026-08-03/sprints/04-application-handler-extraction.md). | **[Observed]** Partially adoptable. The intent transfers; the route list does not. |
