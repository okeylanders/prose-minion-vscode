...
const RESERVED_PERSONA_FRAME =
  /<\/?(?:pinned-excerpt|context-attachments?|writer-message|workshop-tool-evidence|workshop-host-update|workshop-todo-snapshot|writer-owned-task|workshop-capability-result|workshop-transcript|workshop-guest-catch-up|workshop-guest-handoff|workshop-excerpt-source|thread-artifact|agent-artifact|prose-minion-tool-call)(?=[\s/]|>)[^>]*>/gi;
