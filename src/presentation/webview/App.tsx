...
type PersistedState = {
  ...
  tokenTotals?: { promptTokens: number; completionTokens: number; totalTokens: number; costUsd?: number; isEstimate?: boolean };
};
...
export const App: React.FC = () => {
  ...
  const [tokenTotals, setTokenTotals] = React.useState<{ promptTokens: number; completionTokens: number; totalTokens: number; costUsd?: number; isEstimate?: boolean }>(
